      ...
      {isLoading ? (
        ...
        <>
          <View
            ...
            className="h-full flex-1 flex-1 bg-light-primary  py-4 dark:bg-dark-primary">
            <View className="w-full flex-row items-center justify-between px-4">
              ...
              <View className="">
                <Pressable
                  ...
                  className="h-12 w-12 items-center justify-center rounded-full bg-light-secondary dark:bg-dark-secondary">
                  <Icon name="X" size={25} />
                </Pressable>
              </View>
            </View>
            ...
            <View className="w-full items-center justify-center border-t border-light-secondary bg-light-primary px-4 pt-4 dark:border-dark-secondary dark:bg-dark-primary">
              <Pressable
              ...
              <Text className="mt-3 dark:text-dark-subtext">Recurring billing. Cancel anytime</Text>
            </View>
          </View>
...
const SelectPlan = (props: {
  ...
  return (
    <Pressable
      onPress={onSelect}
      className={`mb-4 flex-row items-center justify-between rounded-lg  border p-4  ${isSelected ? 'border-highlight' : 'border-light-secondary dark:border-dark-secondary'}`}>
      <View>
      ...
      <View
        className={`h-6 w-6 items-center justify-center rounded-full border bg-light-secondary dark:bg-dark-secondary ${isSelected ? 'border-sky-500' : 'border-transparent'}`}>
        <View
