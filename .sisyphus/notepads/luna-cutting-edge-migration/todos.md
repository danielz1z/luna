## Task 8 - Migrate app screens to Unistyles

- [completed] 1. Create/maintain task tracker (this file)
- [completed] 2. Migrate `app/_layout.tsx`
- [completed] 3. Migrate drawer screens: `app/(drawer)/index.tsx`, `app/(drawer)/lottie.tsx`, `app/(drawer)/results.tsx`, `app/(drawer)/suggestions.tsx`
- [completed] 4. Migrate `app/[...404].tsx`
